...
for seed in [1, 165, 2521, 12345, 842107]:
 # Read data
    ...
    DataVisualizer.visualize_data(problem_type, test_data, test_result, 'Test data', f'output/test_data_sigmoid_entropy_{seed}.png')
print(f'Total accuracy: {accuracy/5*100:.3f}%')
